const translations = {
    vi: {
        ...
        musicUploadFile: "Chọn file tải lên",
        musicSwitchToFile: "📤 Chọn file tải lên",
        musicSwitchToSystem: "← Chọn nhạc hệ thống",
        ...
        polarPayment: "Thanh toán quốc tế (Polar)",
        polarPaymentDesc: "Dành cho người dùng quốc tế",
        polar_window_hidden: "Cửa sổ thanh toán bị ẩn?",
        polar_open_window: "Mở cửa sổ thanh toán",
        orderHistory: "📋 Lịch sử đơn hàng",
        orderHistoryTitle: "📋 Lịch sử đơn hàng",
        orderHistoryLoading: "Đang tải...",
        orderHistoryEmpty: "Chưa có đơn hàng.",
        orderHistoryError: "Không tải được lịch sử đơn.",
        orderStatusFree: "Miễn phí",
        orderStatusPending: "Chờ thanh toán",
        orderStatusPaid: "Đã thanh toán",
        orderPay: "Thanh toán",
        orderCopyCode: "Copy mã",
    },
    en: {
        ...
        musicUploadFile: "Choose file to upload",
        musicSwitchToFile: "📤 Choose file to upload",
        musicSwitchToSystem: "← Choose system music",
        ...
        polarPayment: "International payment (Polar)",
        polarPaymentDesc: "For international users",
        polar_window_hidden: "Payment window hidden?",
        polar_open_window: "Open payment window",
        orderHistory: "📋 Order history",
        orderHistoryTitle: "📋 Order history",
        orderHistoryLoading: "Loading...",
        orderHistoryEmpty: "No orders yet.",
        orderHistoryError: "Could not load order history.",
        orderStatusFree: "Free",
